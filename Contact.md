...
Revised date: 24/04/2024

Between me KIBONGO Simon Peter 
...
We build sites based on the current best practices and to the highest standard we have. I promise that I'll do my best to do right by you and anticipate any techinical changes that may come up. We're human's though and sometimes something may get missed. In which case we have a <strike>cage match</strike> sit down and figure out how we can work it out together.
...
### Mobile browser testing (if we're doing responsive)
...
We can’t guarantee that our work will be error-free and so we can’t be liable to you or any third-party for damages, including lost profits, lost savings or other incidental, consequential or special damages, even if you’ve advised us of them. Total liability of either party (that means both of us) will be limited to the original contract value.
...
Although the language is simple, the intentions are serious and this contract is a legal document under exclusive jurisdiction of Rwandan courts. 
